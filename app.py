...
AudioSegment.converter = "C:\\ffmpeg-4.3.1-2020-10-01-essentials_build\\bin\\ffmpeg.exe"
...
class ConvertingMedia:
    def __init__(self,root):
        ...
        self.root.iconbitmap("logo329.ico")
    ...
    #=====================================================================#
        ...
        def Convert_format(): 
            if save_song.get()!=0:
                try:
                    AudioSegment.ffmpeg = "C:\\ffmpeg-4.3.1-2020-10-01-essentials_build\\bin\\ffmpeg.exe"
                    AudioSegment.ffprobe ="C:\\ffmpeg-4.3.1-2020-10-01-essentials_build\\bin\\ffprobe.exe"    
                    sound = AudioSegment.from_file(filename,format="mp4") #,format="mp4"
                    prg.start(10)
                    sound.export("{}.mp3".format(save_song.get()), format="mp3", bitrate="128k")
                    prg.stop()
    ...
    #=====================================================================#
        ...
        lab_file=Label(lab_frame,text="Select the file",font=('times new roman',12,'bold'))
        lab_file.place(x=190,y=80)

        lab_enter_name=Label(lab_frame,text="Enter Name to save",font=('times new roman',11,'bold'))
